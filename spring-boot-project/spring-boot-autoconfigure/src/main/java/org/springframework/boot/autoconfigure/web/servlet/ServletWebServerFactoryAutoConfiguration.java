...
@ConditionalOnClass(ServletRequest.class) // 项目依赖中要有ServletRequest类
@ConditionalOnWebApplication(type = Type.SERVLET) // spring mvc类型
@EnableConfigurationProperties(ServerProperties.class) // 创建ServerProperties对象 上面条件满足才执行
@Import({ ServletWebServerFactoryAutoConfiguration.BeanPostProcessorsRegistrar.class,
		ServletWebServerFactoryConfiguration.EmbeddedTomcat.class,
		ServletWebServerFactoryConfiguration.EmbeddedJetty.class,
		ServletWebServerFactoryConfiguration.EmbeddedUndertow.class })
public class ServletWebServerFactoryAutoConfiguration { // 自动配置类

	@Bean
	public ServletWebServerFactoryCustomizer servletWebServerFactoryCustomizer(ServerProperties serverProperties,
			ObjectProvider<WebListenerRegistrar> webListenerRegistrars,
			ObjectProvider<CookieSameSiteSupplier> cookieSameSiteSuppliers) { // BeanPostProcessorsRegistrar  处理使使用ServletWebServerFactoryCustomizer的customize方法
...
//			向Spring容器中注册WebServerFactoryCustomizerBeanPostProcessor
